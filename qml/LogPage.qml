        ...
        Rectangle{
            ...
            Rectangle {
                ...
                TextInput {
                    ...
                    onAccepted: {
                        if(username_input.text.length<1){
                            error_label.text = "Please type a valid username";
                            error_label.color = "red";
                            error_label.visible = "true";
                        }
                        else if(username_input.text.indexOf(" ")>(-1)){
                            error_label.text = "Whitespace on username is forbidden";
                            error_label.color = "red";
                            error_label.visible = "true";
                        }
                        else if(username_input.text.indexOf("\\")>(-1)){
                            error_label.text = "Slash character on username is forbidden";
                            error_label.color = "red";
                            error_label.visible = "true";
                        }
                        else if(password_input.text.length<1){
                            error_label.text = "Please type a valid password";
                            error_label.color = "red";
                            error_label.visible = "true";
                        }
                        else if(password_input.text.indexOf(" ")>(-1)){
                            error_label.text = "Whitespace on password is forbidden";
                            error_label.color = "red";
                            error_label.visible = "true";
                        }
                        else if(password_input.text.indexOf("\\")>(-1)){
                            error_label.text = "Slash character on password is forbidden";
                            error_label.color = "red";
                            error_label.visible = "true";
                        }
                        else{
